...
import com.example.covidtracker.di.component.DaggerFragmentComponent
import com.example.covidtracker.di.component.FragmentComponent
...
abstract class BaseFragment<VM : BaseViewModel> : Fragment() {
    ...
    private fun buildFragmentComponent() =
        DaggerFragmentComponent
            .builder()
            .applicationComponent((context!!.applicationContext as CovidTracker).applicationComponent)
